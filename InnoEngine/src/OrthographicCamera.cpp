...
{
    auto OrthographicCamera::create( float left, float right, float bottom, float top ) -> Owned<OrthographicCamera>
    {
        Owned<OrthographicCamera> pOrthoCamera( new OrthographicCamera() );
