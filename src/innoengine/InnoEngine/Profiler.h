...
{
    switch ( ppoint ) {
    case ProfilePoint::TotalFrame: return "Total";
    case ProfilePoint::MainThreadTotal: return "MainThreadTotal";
    case ProfilePoint::UpdateThreadTotal: return "UpdateThreadTotal";
    case ProfilePoint::Update: return "Update";
    case ProfilePoint::Render: return "Render";
    case ProfilePoint::Count: return "Invalid Profileelement";
    }
    return "Unknown";
};
